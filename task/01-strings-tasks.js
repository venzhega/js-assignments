...
function extractNameFromTemplate(value) {
    return value.substring("Hello,".length, value.length - 1).trim();
}
...
function getCardId(value) {
    ...
    if (suit === '♣') {
        ...
        suitIndex = suitSize * 2;
    } else if (suit === '♠') {
        suitIndex = suitSize * 3;
    }

    const card = value.substring(0, 1);
    let cardIndex = "A234567891JQK".indexOf(card);
